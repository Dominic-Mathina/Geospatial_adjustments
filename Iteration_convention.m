...
%%
 ...
 %Initial approximate values for photo1
   Xo1=2.475676867224182*1000;
   Yo1=0.419220099360606*1000;
   Zo1=0.530281205866918*1000;
   om1=-0.000018409208538*1000;
   phi1= -0.000163123755095*1000;
   K1=-0.000009106564776*1000;
   %Initial approximate values for photo2

   Xo2=3.048589447292532*1000;
   Yo2=0.401894408940324*1000;
   Zo2=0.441905677131838*1000;
   om2=-0.000018171765427*1000;
   phi2=-0.000151175432137*1000;
   K2= 0.000003825510720*1000;
   ...
   Points=1000*[ 2.606572728118526 0.438352403880042 2.085289030386366
           3.312829845381624 0.403551739344913 2.152439679199895
           3.015573356087229 0.658338482425515 1.999356739905270
            3.013079675405523 0.415818277726376 2.194648381676973];
       Xp=Points(:,1);
       Yp=Points(:,2);
       Zp=Points(:,3);
